...
?>
  ...
  <tbody>  
    ...
    <tr align="center">
      ...
      <td align="center"><a href="editadmin.php?id=<?php echo $row["id"];?>"> <i class="fas fa-file-signature"></i>แก้ไข </a>
		  
		  
		  
		  
		  <a class="nav-link" href="JavaScript:if(confirm('ยืนยันที่จะลบ')==true){window.location='savedeladmin.php?id=<?php echo $row["id"];?>';}">
          <i class="fas fa-fw fa-eraser"></i>
          <span>ลบ</span></a>
		  
    </tr>
	  <?php }?>	
	  <a href="addadmin2.php"><i class="fas fa-file-medical"></i>เพิ่ม </a>
    <tr align= right>
      <td colspan="3"></th>
    </tr>
    </tbody>
