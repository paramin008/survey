        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">จัดการ</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
     
			  <table align="left" width="59%" class="table">
  <thead align="center" class="thead-dark">
    <tr>
		<th scope="col">ID</th>
      <th scope="col" align="left">รายการคำถาม</th>
...
?>
  ...
  <tbody>  
    ...
    <tr align="center">
      ...
      <td align="center"><a href="editq.php?id_question=<?php echo $row["id_question"];?>"> <i class="fas fa-file-signature"></i>แก้ไข </a>
		  
		  
		  
		  
		  <a class="nav-link" href="JavaScript:if(confirm('ยืนยันที่จะลบ')==true){window.location='savedel.php?id_question=<?php echo $row["id_question"];?>';}">
          <i class="fas fa-fw fa-eraser"></i>
          <span>ลบ</span></a>
		  
    </tr>
	  <?php }?>	
	  <a href="add.php"><i class="fas fa-file-medical"></i>เพิ่ม </a>
    <tr align= right>
      <td colspan="3"></th>
    </tr>
    </tbody>
