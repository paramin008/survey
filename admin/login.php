              ...
              <div class="col-lg-12">
                <div class="p-4">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">เข้าสู่ระบบ(ผู้ดูแลระบบ)</h1>
                  </div>
                 <form name="form1" method="post" action="../admin/check_login.php">
				   ...
				   <form name="form2" method="post" action="../index.php">
					   <input type="submit" class="btn btn-danger btn-user btn-block" name="back" value="back">
					   </form>
<div class="text-center">
