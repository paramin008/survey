...
<form action="saveadmin.php" name="frmAdd" method="post">
<table width="488" height="269" border="0" align="center">
  ...
  <div class="col-10">
    <input class="form-control" type="text" required placeholder="กรุณาใส่ Username" name="username" value="" id="username">
  </div>
</div>
		  <div class="form-group row">
 <label for="example-password-input" class="col-9 col-form-label">Password</label>
  <div class="col-10">
    <input class="form-control" type="password" required placeholder="กรุณาใส่ Password" value="" name="password" id="password">
  </div>
		  </div>
<div class="form-group row">
  <label for="example-email-input" class="col-9 col-form-label">ชื่อ</label>
  <div class="col-10">
    <input class="form-control" type="text" required value="" name="fname" placeholder="กรุณาใส่ชื่อ" id="fname">
  </div>
</div>
<div class="form-group row">
  <label for="example-url-input" class="col-9  col-form-label">นามสกุล</label>
  <div class="col-10">
    <input  class="form-control" type="text" required placeholder="กรุณาใส่นามสกุล" name="lname" id="lname" value="">
  </div>
</div>
<div class="form-group row">
