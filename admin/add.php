        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">เพิ่มคำถาม</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
<form action="saveadd.php" name="frmAdd" method="post">
<table width="488" height="269" border="0" align="center">
  <td width="234"><tbody>
    <tr>
      ...
      <input type="text" class="form-control" name="question" id="inputEmail4" >
    </div>
