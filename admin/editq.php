...
<!-- Page Wrapper -->
  <div id="wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">แก้ไขคำถาม</h6>
            </div>
            <div class="card-body">
	...
	$strSQL_MEM = "SELECT * FROM tb_question WHERE id_question = '$id_question' ";
$objQuery_MEM = mysqli_query($dbcon,$strSQL_MEM);
$objResult_MEM = mysqli_fetch_array($objQuery_MEM,MYSQLI_ASSOC);
	
?>
<form action="saveedit.php" name="frmAdd" method="POST">
<table width="388" height="269" border="0" align="center">
  <td width="234"><tbody>
    <tr>
      <td><form>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4"></label>
		 <input type="text" readonly hidden="" class="form-control-plaintext"  name="id_question" id="id_question" value="<?php echo $objResult_MEM["id_question"];?>">
    
    </div>
    <div class="form-group col-md-12">
      <label for="inputPassword4">คำถาม</label>
      <input type="text" class="form-control"   name="question" value="<?php echo $objResult_MEM["question"];?>" id="question" >
    </div>
