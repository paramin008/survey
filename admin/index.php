...
<link href="https://fonts.googleapis.com/css2?family=Kanit:wght@100;300&display=swap" rel="stylesheet">
  ...
  <title>สรุปปัจจัยในการเข้าศึกษา</title>
...
$query = "SELECT score, COUNT(id_person) as qty FROM tb_answer GROUP BY score";;
...
$totol = implode(",", $totol); 
?>
                  <h6 class="m-0 font-weight-bold text-primary">แผนภูมิรายงาน</h6>
...
var myChart = new Chart(ctx, {
    ...
    data:  {
        ...
        datasets: [{    label: 'รายงานปัจจัย  (คน)',
            data: [<?php echo $totol;?>
            ],
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
...
$query = "SELECT education, COUNT(id_person) as qtyeducation FROM tb_person GROUP BY education";;
$result = mysqli_query($dbcon, $query);
$resultchart = mysqli_query($dbcon, $query);  
$datesave1 = array();
$totol1 = array();
while($rs = mysqli_fetch_array($resultchart)){ 
  $datesave1[] = "\"".$rs['education']."\""; 
  $totol1[] = "\"".$rs['qtyeducation']."\""; 
}
...
<p>	
 <!--devbanban.com-->
<canvas  id="myChart20" width="800px" height="300px"></canvas>
<script> 
...
var myChart = new Chart(ctx, {
    ...
    data:  {
        ...
        datasets: [{    label: 'รายงานระดับการศึกษา  (คน)',
...
$query = "SELECT province_name, COUNT(id) as qty FROM tb_detil INNER JOIN tbl_provinces ON province = province_id GROUP BY province_name ";;
$result = mysqli_query($dbcon, $query);
$resultchart = mysqli_query($dbcon, $query);  
$datesave3 = array();
$totol3 = array();
while($rs = mysqli_fetch_array($resultchart)){ 
  $datesave3[] = "\"".$rs['province_name']."\""; 
  $totol3[] = "\"".$rs['qty']."\""; 
}
...
<p>	
 <!--devbanban.com-->
<canvas  id="myChart23" width="800px" height="300px"></canvas>
<script> 
var ctx = document.getElementById("myChart23").getContext('2d');
var myChart = new Chart(ctx, {
    type: 'horizontalBar',
    data:  {
        labels:  [<?php echo $datesave3;?>
    
        ],
        datasets: [{    label: 'รายงานจังหวัด  (คน)',
