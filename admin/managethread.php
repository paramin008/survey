...
<section class="ftco-section ftco-no-pt">
  <table class="table table-condensed" width="84%">
    <tbody>
      <tr>
        <td width="4%">#</td>
        <td width="27%" align="center">หัวข้อ</td>
        <td width="15%" align="center">ผู้ลง</td>
        <td width="16%" align="center">เวลา</td>
        <td width="16%" align="center">คนดู</td>
        <td width="22%" align="center">คนตอบ</td>
		   <th width="20%" align="center">Action</th>
      </tr>
		 <?php
while($objResult_MEM = mysqli_fetch_array($objQuery_MEM))    
{
?>
  <tr>
    <td><p><?php echo $objResult_MEM["QuestionID"];?></p></td>
    <td align="center"><a href="viewthread.php?QuestionID=<?php echo $objResult_MEM["QuestionID"];?>"><?php echo $objResult_MEM["Question"];?></a></td>
    <td align="center"><?php echo $objResult_MEM["Name"];?></td>
    <td align="center"><?php echo $objResult_MEM["CreateDate"];?></td>
    <td align="center" ><?php echo $objResult_MEM["View"];?></td>
    <td align="center"><?php echo $objResult_MEM["Reply"];?></td>
	   <td align="center">
	<a href="deletethread.php?QuestionID=<?php echo $objResult_MEM["QuestionID"];?>"><i class="fas fa-fw fa-eraser"></i>ลบ</a>
  </tr>
<?php
}
?>
